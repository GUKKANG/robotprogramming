...
class PosPublisher(Node):
    def __init__(self):
        ...
        self.delta = 0.1
        self.state_sub = self.create_subscription(XYpos, 'robot_state', self.state_callback, 10)

    def state_callback(self, msg):
        self.q1_curr = msg.qpos1
        self.q2_curr = msg.qpos2
        
        if self.q1des is None:
            self.q1des = self.q1_curr
        if self.q2des is None:
            self.q2des = self.q2_curr
