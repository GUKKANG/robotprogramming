...
class RobotDriver(Node):
    def __init__(self):
        ...
        # PID 제어기 설정 
        self.pid_q1 = PIDController(kp=1.0, ki=0.0, kd=0.01, dt=self.dt, max_vel=0.7)
        self.pid_q2 = PIDController(kp=1.0, ki=0.0, kd=0.01, dt=self.dt, max_vel=1.0)
